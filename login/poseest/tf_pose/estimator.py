...
from login.poseest.tf_pose import common
from login.poseest.tf_pose.common import CocoPart
from login.poseest.tf_pose.tensblur.smoother import Smoother
'''import tensorflow.contrib.tensorrt as trt'''
'''from tensorflow.python.compiler.tensorrt import trt_convert as trt'''

try:
    from login.poseest.tf_pose.pafprocess import pafprocess
...
class BodyPart:
    ...
    def __str__(self):
        return '%d %.2f %.2f %.2f' % (self.part_idx, self.x, self.y, self.score)
